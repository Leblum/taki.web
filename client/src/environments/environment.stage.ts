export const environment = {
    production: false,
    IdentityAPIBase: 'https://stage.identity.leblum.io/api',
    V1: '/v1',
    ProductAPIBase: 'https://stage.product.leblum.io/api',
    ...
    WooApiLocation: 'https://staging.leblum.com/wp-json/wc/v2/orders',
